...
const PREVIEW_TEXT = `Utpalaa – The Condoville is an exclusive luxury residential enclave located at Ruby, off EM Bypass, one of Kolkata's most sought-after residential locations. Crafted by Ambuja Neotia, the project offers thoughtfully designed, vaastu-compliant residences featuring expansive layouts, abundant natural light and panoramic views.`

const MORE_TEXT = ` Surrounded by lush greenery yet strategically positioned close to major business hubs, healthcare, education and lifestyle destinations, Utpalaa at Ruby, off EM Bypass delivers a refined living experience that blends urban convenience with calm, nature-led living.`
