        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Ambuja Neotia Group is one of Bengal&apos;s most respected real estate conglomerates, renowned for creating landmark developments across residential, hospitality, and commercial sectors. With a distinguished legacy of thoughtful design and quality craftsmanship, Ambuja Neotia continues to redefine the standards of luxury living in Eastern India.</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                ...
                { value: '20000+', label: 'Happy Families' },
              ].map((stat, i) => (
                <div key={i} style={{
